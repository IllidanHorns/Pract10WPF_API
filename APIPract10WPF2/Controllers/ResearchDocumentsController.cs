...
namespace APIPract10WPF2.Controllers
{
    ...
    public class ResearchDocumentsController : ControllerBase
    {
        ...
        public ResearchDocumentsController(Pract10WpfDbContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != researchDocument.IdAppoinmentDocument)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<ResearchDocument>> PostResearchDocument(ResearchDocument researchDocument)
        {
            ...
            {
                if (ResearchDocumentExists(researchDocument.IdAppoinmentDocument))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetResearchDocument", new { id = researchDocument.IdAppoinmentDocument }, researchDocument);
        }
        ...
        {
            return _context.ResearchDocuments.Any(e => e.IdAppoinmentDocument == id);
        }
    }
}
