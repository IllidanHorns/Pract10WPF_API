...
namespace APIPract10WPF2.Controllers
{
    ...
    public class AppoinmentsController : ControllerBase
    {
        ...
        public AppoinmentsController(Pract10WpfDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Appoinment>> PostAppoinment(Appoinment appoinment)
        {
            ...
            return CreatedAtAction("GetAppoinment", new { id = appoinment.IdAppoinment }, appoinment);
        }
        ...
        {
            return _context.Appoinments.Any(e => e.IdAppoinment == id);
        }
    }
}
