...
namespace APIPract10WPF2.Controllers
{
    ...
    public class AnalysDocumentsController : ControllerBase
    {
        ...
        public AnalysDocumentsController(Pract10WpfDbContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != analysDocument.IdAppoinmentDocument)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<AnalysDocument>> PostAnalysDocument(AnalysDocument analysDocument)
        {
            ...
            {
                if (AnalysDocumentExists(analysDocument.IdAppoinmentDocument))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetAnalysDocument", new { id = analysDocument.IdAppoinmentDocument }, analysDocument);
        }
        ...
        {
            return _context.AnalysDocuments.Any(e => e.IdAppoinmentDocument == id);
        }
    }
}
